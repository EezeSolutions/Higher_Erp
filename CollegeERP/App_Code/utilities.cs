...
public class utilities
{
     ...
     public static Byte[] generatePdfFromHtml(string html, int landscape, string enumber)
    {
     ...
     public static void sendSms(string newMessage, string number)
     {
         try
         {
             string urlToPost
   = "http://sms.bbnplace.com/bulksms/bulksms.php?username=polyibadan2014@gmail.com&password=Digital00&sender=2348038145411&message=" + newMessage + "&mobile=" + number;

             string html = gethtml(urlToPost);
