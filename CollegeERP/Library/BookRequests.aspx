<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="BookRequests.aspx.cs" Inherits="Library_Default" %>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="row">
                            <table class="table table-responsive table-hover"><tr class="blue-background"><th>Book Name</th><th>Category</th><th>ISBN</th><th>Available Books</th><th>Student Name</th><th>Action</th></tr>
