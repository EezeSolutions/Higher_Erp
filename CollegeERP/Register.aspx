                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="HasJambData" runat="server" Visible="false">
                                                    <div class="loginPanel" style="width: 850px">
                                                        ...
                                                        <br />
                                                        <h2 class="btn btn-brown btn-block btn-sm">The Polytechnic Ibadan Application Form - JAMB-UTME Examination</h2>
                                                        <br />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:DropDownList AppendDataBoundItems="true"
                                                                        AutoPostBack="true" DataTextField="SubjectName" DataValueField="ID"
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox runat="server" AutoPostBack="true" Style="text-align: center" ID="txtScore1" placeholder="(0 - 100) Strict  - Numeric" class="form-control"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <asp:TextBox runat="server" AutoPostBack="true" Style="text-align: center" ID="txtscore2" placeholder="(0 - 100) Strict  - Numeric" class="form-control"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <asp:TextBox runat="server" AutoPostBack="true" Style="text-align: center" ID="txtscore3" placeholder="(0 - 100) Strict  - Numeric" class="form-control"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <asp:TextBox runat="server" AutoPostBack="true"  Style="text-align: center" ID="txtscore4" placeholder="(0 - 100) Strict  - Numeric" class="form-control"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:DropDownList  DataTextField="InstitutionName"
                     ...
                     <label class="col-sm-4 control-label"></label>
                       ...
                       <div class="col-sm-4">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="updatePanel_StudentBio">
                                            ...
                                            <ContentTemplate>
                                                <asp:Panel ID="HasBioDataSection" runat="server">
                                                    <!-- Modal -->
                                                    <div class=" col-sm-12"">
                                                        <%--<div class="site-logo text-center"><img src="../Images/logo.jpg" /></div>--%>
                                                        <br />
                                                        <h2 class="btn btn-brown btn-block btn-sm">The Polytechnic Ibadan Application Form - Student BioData</h2>
                                                        <br />
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                   ...
                                                                   <%-- <asp:SqlDataSource ID="sqlDatasource_STO" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Application_States] where status = 0 "></asp:SqlDataSource>--%>
                                                                    ...
                                                                    <asp:DropDownList AutoPostBack="true" CssClass="form-control" AppendDataBoundItems="true" DataTextField="State" DataValueField="ID" runat="server" ID="dropdownSto">
                                            ...
                                            <ContentTemplate>
                                                <asp:Panel ID="HasOlevelResult" runat="server" Visible="false">
                                                    ...
                                                    <div class="loginPanel" style="width: 850px">
                                                        <%--<div class="site-logo text-center"><img src="../Images/logo.jpg" /></div>--%>
                                                        <br />
                                                        <h2 class="btn btn-brown btn-block btn-sm">The Polytechnic Ibadan Application Form - O'Level Result</h2>
                                                        <br />
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="HasPreviousRecord" runat="server" Visible="false">
                                                    <div class="loginPanel" style="width: 850px">
                                                        <%--<div class="site-logo text-center"><img src="../Images/logo.jpg" /></div>--%>
                                                        <br />
                                                        <h2 class="btn btn-brown btn-block btn-sm">The Polytechnic Ibadan Application Form - Previous Record</h2>
                                                        <br />
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="HasCBTSchedule" runat="server" Visible="false">
                                                    <div class="loginPanel" style="width: 850px">
                                                        <%--<div class="site-logo text-center"><img src="../Images/logo.jpg" /></div>--%>
                                                        <br />
                                                        <h2 class="btn btn-brown btn-block btn-sm">The Polytechnic Ibadan Application Form - CBT Schedule</h2>
                                                        <br />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <asp:DropDownList CssClass="form-control" AutoPostBack="true" AppendDataBoundItems="true" DataTextField="ScheduleDate" DataValueField="ScheduleDate" runat="server" ID="dropdownScheduleDate">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <asp:DropDownList CssClass="form-control" AutoPostBack="true" DataTextField="ScheduleTime" DataValueField="ID" AppendDataBoundItems="true" runat="server" ID="dropdownTime">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="updatePanel4">
                                            ...
                                            <ContentTemplate>
                                                <asp:Panel ID="panelPreview" runat="server" Visible="false">
                                                    ...
                                                    <div class="loginPanel" style="width: 850px">
                                                        <%--<div class="site-logo text-center"><img src="../Images/logo.jpg" /></div>--%>
                                                        <br />
                                                        <h2 class="btn btn-brown btn-block btn-sm">The Polytechnic Ibadan Application Form - Preview</h2>
                                                        <br />
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <asp:Button runat="server" Visible="true" ID="Button1" Width="150px" CssClass="btn btn-brown" Text="Edit Application" />

                                                </div>

                                                <div class="col-sm-3">

                                                    <asp:Button runat="server" Visible="true" ID="btnSubmit" Width="150px"  CssClass="btn btn-brown" Text="Submit Application" />
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <asp:Button runat="server" Visible="false" ID="btnPrevious" Width="150px" CssClass="btn btn-brown" Text="Previous Page" />

                                                </div>

                                                <div class="col-sm-3">

                                                    <asp:Button runat="server" Visible="true" ID="btnSave" Width="150px" CssClass="btn btn-brown" Text="Save Application" />

                                                </div>

                                                <div class="col-sm-3">

                                                    <asp:Button runat="server" Visible="false" ID="btnNext" Width="150px" CssClass="btn btn-brown" Text="Next Page" />
                                                    <asp:Button runat="server" Visible="false" ID="btnPreview" Width="150px"  CssClass="btn btn-brown" Text="Preview Form" />
