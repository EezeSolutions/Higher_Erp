<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProcesseddApplications.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2>
eWALLET PROCESSED DEPOSIT APPLICATIONS
</h2>
...
<script type="text/javascript">
    ...
    function updateDepositForm(trnum, userID) {
        ...
        if (delFlag) {
            ...
            $.ajax({
                type: "POST",
                url: "ProcesseddApplications.aspx/depositFormUpdate",
    ...
    function GeteWalletPayment(pageIndex) {
        ...
        $.ajax({
            type: "POST",
            url: "ProcesseddApplications.aspx/GeteWalletPayment",
    ...
    function searcheWallet() {
        ...
        $.ajax({
            type: "POST",
            url: "ProcesseddApplications.aspx/searchTran",
